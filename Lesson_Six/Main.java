...
public class Main {
    public static void main(String[] args) {
        ...
        animals[0] = new Cat(200,10);
        animals[1] = new Cat(170,15);
        animals[2] = new Dog(500,1,10);
        animals[3] = new Dog(600,3,15);

        for (int i = 0; i < animals.length; i++) {
            System.out.println(animals[i].run(220));
            System.out.println(animals[i].jump(2));
            System.out.println(animals[i].swim(12));
        }
    }
}
